...
<ul>
    <li><a class="inactive" href="proto.php">About</a></li>
    <li><a class="inactive" href="proto_browse.php">Browse</a></li>
    <li><a class="active" href="proto_sources.php">Sources</a></li>
</ul>
 ...
 <div id="contentwrapper" class="clearfix">
     <div id="content">    
	 <!-- SIDEBAR proto -->
<h2>Sources of the Benchmark Database for Linguistic Reconstruction</h2>
<br><br>

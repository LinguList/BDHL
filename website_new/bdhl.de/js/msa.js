...
function sortTable(){
  ...
  var tmp = document.getElementById("stable");
  if(tmp.innerHTML == "Sort phonetic")
  {
    tmp.innerHTML = "Sort alphabetic";
  }
  else
  {
    tmp.innerHTML = "Sort phonetic";
  }
}
function toggle(){
  var tbl = document.getElementById("msa").tBodies[0];
  ...
  var tmp = document.getElementById("useq");
  if(tmp.innerHTML == "Show unique sequences")
  {
    tmp.innerHTML = "Show all sequences";
  }
  else
  {
    tmp.innerHTML = "Show unique sequences";
  }

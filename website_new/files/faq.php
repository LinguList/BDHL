...
<br>
<p>In order to exchange, edit, and compare phonetic alignments, different formats are used in the BDPA. Generally, we distinguish between two formats, one for pairwise alignments (PSA-format)
...
respective pairwise (PSA) and multiple (MSA) alignments.</p><br>
